  ...
  const sliderItem = (
    <div className="bg-white shadow-[0px_3px_30px_rgba(100,100,100,0.17)] p-4 lg:p-5 rounded-2xl m-2">
      <div className="mb-4">
        ...
        <div className="text-sm lg:text-base text-secondary-800 font-bold mb-2">
          <span>دوره گیت و گیت هاب</span>
        </div>
        <div className="h-44 overflow-y-auto pl-1 mb-2">
          <p className="text-sm leading-7 text-secondary-900 lg:leading-7 mb-4">
          ...
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center gap-x-3 flex-1">
              ...
              <div className="flex flex-col justify-evenly text-secondary-900 text-[10px]">
                <div className="flex items-center font-extrabold md:mb-0.5 md:text-xs">
                  <span>علیرضا احمدی</span>
                  <span className="mr-1 font-normal text-[10px] lg:text-xs text-secondary-400">
                    (۱۴۰۲/۱۰/۲۴)
                  </span>
                </div>
                <span className="opacity-80 text-sm">خریدار محصول</span>
              </div>
            </div>
